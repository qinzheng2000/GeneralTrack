...
class Exp(MyExp):
    ...
    def get_eval_loader(self,  args_, batch_size, is_distributed, testdev=False):
        ...
        if testdev:
            valdataset = MOTDataset(
                data_dir=os.path.join('datasets', "dancetrack"),
    ...
    # def get_evaluator(self, batch_size, is_distributed, testdev=False, args):
    #     from yolox.evaluators import COCOEvaluator
    #
    #     val_loader = self.get_eval_loader(batch_size, is_distributed, testdev=testdev, args)
